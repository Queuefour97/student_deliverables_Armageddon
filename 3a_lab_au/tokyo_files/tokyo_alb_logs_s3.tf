...
#   zone_id = "Z0577510JJCMGIYZ7086"    # local.shinjuku_zone_id
#   name    = local.shinjuku_app_fqdn #var.domain_name
#   type    = "A"
...
#
# NOTE: ***Added resource on 01/31/2026, inside aws_lb.shinjuku_alb01 in bonus_b.tf
#
