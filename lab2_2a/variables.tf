variable "aws_region" {
  description = "AWS Region for armageddon final."
  type        = string
  default     = "us-east-1"
}
...
variable "project_name" {
  ...
  type        = string
  default     = "armageddon-final"
}

variable "vpc_cidr" {
  description = "VPC CIDR (use 10.108.0.0/16 as instructed)."
  type        = string
  default     = "10.108.0.0/16" # TODO: student supplies
}

variable "public_subnet_cidrs" {
  description = "Public subnet CIDRs (use 10.108.0.0/24)."
  type        = list(string)
  default     = ["10.108.1.0/24", "10.108.2.0/24"] # TODO: student supplies
}

variable "private_subnet_cidrs" {
  description = "Private subnet CIDRs (use 10.108.0.0/24)."
  type        = list(string)
  default     = ["10.108.101.0/24", "10.108.102.0/24"] # TODO: student supplies
}
...
variable "db_password" {
  ...
  type        = string
  sensitive   = true
  default     = "armageddon!" # TODO: student supplies
}

variable "sns_email_endpoint" {
  description = "Email for SNS subscription (PagerDuty simulation)."
  type        = string
  default     = "jorune.simpkins@gmail.com" # TODO: student supplies
}

# variable "domain_name" {
#   description = "Base domain students registered (e.g., firstpointand.click)."
#   type        = string
...
#   type        = string
#   default     = "app.chewbacca-growl.com"
# }
